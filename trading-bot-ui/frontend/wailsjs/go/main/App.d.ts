...
export function ExportTradesToCSV():Promise<string>;
...
export function GetPortfolioStats():Promise<portfolio.Stats>;
...
export function TestEmail(arg1:main.EmailSettings):Promise<void>;
